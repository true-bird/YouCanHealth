...
<body>
	...
	<form action="<%=contextPath%>/community/WritingContentupdateSet"
		...
		<table style="padding-top: 50px" align="center" width="1000"
			...
			<tr>
				<td height=20 align=center>내가쓴글 수정하기</td>
			</tr>
			<tr>
				<td>
					<table class="table2">
						...
						<tr>
							...
							<td><input type=text name="title" size=60
								value="${communityDto.title}" required></td>
						</tr>

						<tr>
							<td>내용</td>
							<td><textarea name="content" cols=85 rows=15 resize='none'
									required>${communityDto.content}</textarea></td>
						</tr>
					</table>
					<input type="submit" value="수정">
					<a href="<c:url value='/community/MyCommunityDelete' />?seq=${communityDto.seq}">
